...
export const GUIDES: Record<string, Guide> = {
  "complete-nutrition-guide-school-lunches-australia": {
...
Australian children spend roughly 200 days a year at school, and the lunch they eat accounts for about one-third of their daily nutrition. Getting it right is not just about avoiding a rumbling tummy in the afternoon — it directly affects concentration, mood, energy levels, and long-term health.
...
*Note: Whole nuts are a choking hazard for children under 3. Many Australian schools are also nut-free — always check your school's policy before packing nut products.
...
Water is the recommended drink for Australian school children. Avoid juice boxes and flavoured milks as daily staples — they often contain added sugars equivalent to several teaspoons per serve. A reusable water bottle filled with tap water is the simplest and healthiest choice.
...
### Section 3: Fruit
Include one piece of whole fruit or a small container of cut fruit. Seasonal Australian fruits are the most affordable option — think mandarins and apples in winter, watermelon and stone fruit in summer.
...
The NHMRC recommends limiting **discretionary foods** — those high in saturated fat, added sugars, or salt. In lunchbox terms, this means minimising:

- Packaged chips and savoury snacks
- Chocolate bars and lollies
- Fruit bars with added sugar (check labels — many "fruit" snacks contain very little actual fruit)
...
- Use bento-style lunchboxes with compartments — they make it easy for small hands
...
- Involve children in lunchbox planning — they are more likely to eat what they helped choose
...
- Teenagers need significantly more calories and nutrients — do not underpack
- Protein needs increase sharply during adolescence
- Many teens prefer to pack their own lunches — teach them the quadrant method
...
- **Buy seasonal produce** — it is cheaper and fresher. Check the weekly specials catalogues.
- **Buy in bulk** and portion at home: large tubs of yoghurt into small reusable containers, big bags of carrots cut into sticks.
- **Home-brand is fine** — Woolworths Macro and Coles Organic ranges offer quality at lower price points.
- **Batch cook on weekends** — make a big batch of muffins, frittata, or pasta salad to use across the week.
- **Use leftovers creatively** — last night's roast chicken becomes today's sandwich filling.
...
Start with small changes rather than overhauling the entire lunchbox overnight. Replace one item at a time — swap the packet of chips for veggie sticks and hummus, switch from white bread to wholegrain, add an extra piece of fruit.
...
- [Nutrition Australia — Healthy Lunchbox Week](https://www.nutritionaustralia.org/national/healthy-lunchbox-week)

---

Ready to plan balanced lunchboxes for the whole week? [Try the Aussie Lunchbox Planner →](/en/planner)
`,
  },

  "allergy-management-school-lunchbox-australia": {
...
- **Always read the ingredients list**, even for products you have bought before — formulations change
- **Look for the bold allergen summary** usually found at the end of the ingredients list (e.g., "Contains: Milk, Soy")
- **Check imported products carefully** — they may not comply with Australian labelling standards
...
- **Sunflower seed butter (SunButter)** — available at Woolworths and health food stores; tastes similar to peanut butter
- **WowButter** — a soy-based peanut butter alternative specifically designed for nut-free schools
- **Tahini and honey** — check your school's sesame policy first
- **Cream cheese and cucumber** — simple, safe, and kid-friendly
- **Vegemite** — the classic Australian option; naturally nut-free
...
- **Roasted chickpeas** — crunchy, high-protein, and naturally nut-free
...
- **Yoghurt**: CoYo (coconut), Inside Out (almond/oat — not suitable for nut-free schools), or Kingland soy yoghurt
...
Eggs are hidden in many foods — cakes, muffins, pasta, mayo, and some breads. Alternatives include:
...
- **Aquafaba** (chickpea water) as an egg replacement in baking — whips up like egg whites for meringue-style treats
...
### Meal Planning
- Plan the entire week's lunchboxes on Sunday — this prevents last-minute scrambles that lead to mistakes
...
- **Orgran** — extensive range of allergy-friendly products (gluten-free, egg-free, dairy-free, nut-free)
- **Sweet William** — dairy-free, nut-free chocolate
- **Freedom Foods** — allergen-friendly cereals and snacks
- **YoLife** — dairy-free yoghurt alternatives
...
- [FSANZ — Food allergen labelling](https://www.foodstandards.gov.au/consumer/labelling/allergen)
- [Nip Allergies in the Bub](https://www.preventallergies.org.au)

---

Need help planning allergy-friendly lunchboxes? [Try the Aussie Lunchbox Planner →](/en/planner)
`,
  },

  "budget-lunchbox-planning-guide-australia": {
...
- **Flybuys** points add up — redeem them for money off your shop
...
### Savoury Muffins (Makes 12 — cost ~$5 total)
...
Mix dry ingredients, add wet, stir until just combined. Bake at 180°C for 20 minutes. Freeze individually wrapped.

### Veggie Frittata (Serves 8 — cost ~$6 total)
- 8 eggs ($3.00)
...
Whisk eggs, add vegetables and cheese, pour into a lined baking dish. Bake at 180°C for 25 minutes. Slice into portions, refrigerate or freeze.

### Energy Balls (Makes 20 — cost ~$4 total)
...
### Pasta Salad (Serves 5 — cost ~$5 total)
...
- **Freezing bread** — take out two slices each morning; they defrost by lunchtime and keep the sandwich cool
- **Using veggie scraps** — carrot tops, celery leaves, and onion ends can become stock for soups
- **Checking use-by dates** when you shop — choose items with the longest shelf life
- **Storing produce correctly** — bananas on the bench (not in the fridge), leafy greens in a damp tea towel in the crisper
- **Repurposing uneaten lunchbox items** — if the carrot sticks come home, use them in tonight's stir-fry
...
- **Use different wraps** — mountain bread, rice paper, or tortillas instead of sliced bread
- **Add a tiny treat** occasionally — a few chocolate chips, a homemade biscuit, or a single fun-size item from a multipack
- **Let kids choose** — give them three budget-friendly options and let them pick two for tomorrow's lunchbox
- **Rotate the menu** — even with the same ingredients, different presentations keep things interesting
...
- **Rice and soy sauce** in a thermos — costs under 50 cents
- **Vegemite scrolls** — bread, butter, Vegemite, rolled up and sliced
- **Egg sandwiches** — boiled eggs mashed with a little mayo
- **Banana pikelets** — 1 banana + 1 egg + 1/4 cup flour, cooked in a pan
- **Baked beans on toast** (pack in a thermos) — a tin of baked beans costs about $1
...
- **School breakfast programs** — many Australian schools offer free breakfast through organisations like Foodbank Australia
- **Centrelink payments** including Family Tax Benefit
- **State-based school assistance** — check with your school's welfare coordinator

There is no shame in using these resources. They exist to help families through tough times.

---

Start planning affordable, healthy lunchboxes today. [Try the Aussie Lunchbox Planner →](/en/planner)
`,
  },
...
- **Cheaper** — supply is high, so prices drop. A punnet of strawberries can cost $2 in spring and $7 in winter.
- **Fresher** — seasonal produce has not travelled long distances or been stored for months.
- **Tastier** — fruit picked at peak ripeness simply tastes better, which means kids are more likely to eat it.
- **More nutritious** — fresher produce retains more vitamins and minerals.
...
## Term 1: Late January — March (Late Summer/Early Autumn)
...
- **Watermelon cubes** — freeze them the night before; they act as an ice pack and defrost to a perfect slushy texture by lunch
- **Nectarine halves** — brush with a little lemon juice to prevent browning
- **Corn on the cob** — cook, cut into thirds, and pack wrapped in foil
- **Capsicum strips** with hummus — red and yellow capsicums are sweetest this time of year
- **Grape and cheese skewers** — thread onto a bamboo stick with cubes of cheddar
- **Zucchini slice** — a classic Australian recipe; bake on the weekend and slice for the week
...
## Term 2: April — June (Autumn/Early Winter)
...
- **Pear and cheese** — slice a ripe pear and pair with tasty cheddar
- **Pumpkin soup** in a thermos — roast pumpkin on the weekend, blend with stock, portion into thermos containers
- **Sweet potato muffins** — grate sweet potato into muffin batter for a naturally sweet, veggie-packed snack
- **Broccoli and cheese bites** — mix steamed broccoli with cheese and egg, bake in mini muffin tins
- **Mandarin segments** — easiest lunchbox fruit; they come in their own packaging

### Money-Saving Tip
Apples are at their cheapest during autumn harvest season. Buy a large bag (2kg+) and store in the crisper drawer — they keep for weeks. Granny Smith, Pink Lady, and Royal Gala are all excellent varieties widely grown in Australia.

---

## Term 3: July — September (Winter/Early Spring)
...
- **Mandarin and kiwifruit** — winter's lunchbox heroes; packed with vitamin C to fight colds
- **Avocado on crackers** — mash avocado with a squeeze of lemon and a pinch of salt, pack separately from crackers
- **Minestrone soup** in a thermos — use seasonal cabbage, carrots, celery, and tinned beans
- **Orange segments** — navel oranges are at their sweetest mid-winter
- **Creamy cauliflower pasta** — blend steamed cauliflower into a cheese sauce; kids often cannot tell the difference
- **Spinach and cheese rolls** — use frozen puff pastry, spread with ricotta and wilted spinach, roll and bake
...
## Term 4: October — December (Spring/Early Summer)
...
- **Strawberries** — at their cheapest and most delicious in October/November. Pack whole or sliced.
- **Asparagus spears** — blanch briefly, cool, and pack as finger food. Surprisingly popular with kids when fresh and in season.
- **Pea and mint pasta** — cook pasta with frozen peas, toss with a little olive oil and fresh mint
- **Fresh spring rolls** — rice paper wrappers filled with lettuce, cucumber, and chicken
- **Berry yoghurt parfait** — layer yoghurt with seasonal strawberries and a sprinkle of granola in a small jar
- **Apricot halves** — when they start appearing in late November, they are a delicious natural sweet treat
...
- **Bananas** — Australia's most popular fruit; almost always under $4/kg
- **Carrots** — consistently cheap at $2-3/kg
- **Potatoes and sweet potatoes** — always available
- **Onions** — a cooking staple
- **Frozen peas and corn** — picked and frozen at peak freshness; often more nutritious than "fresh" produce that has been in cold storage
...
If mangoes are $2 each in January, buy extra and freeze them (diced) for smoothies and snacks later. Same for berries — frozen berries are perfect for baking muffins or adding to yoghurt.

### Step 4: Preserve the Glut
When stone fruit, tomatoes, or citrus is dirt cheap:
- **Freeze** — dice and freeze on a tray before transferring to bags
- **Dry** — make fruit leather or sun-dried tomatoes
- **Jar** — simple jams and chutneys extend the season
...
- **Local farmers' markets** — buy direct from growers for the freshest, cheapest options
- **Community gardens and co-ops** — some neighbourhoods run produce-sharing programs
- **Pick-your-own farms** — a fun family outing that also stocks the freezer (check farms near you on websites like PickYourOwn.org.au)

---

Plan your seasonal lunchbox menu today. [Try the Aussie Lunchbox Planner →](/en/planner)
`,
  },

  "school-lunchbox-policy-guide-australia": {
...
- **Protect children with allergies** — particularly those at risk of anaphylaxis
- **Promote healthy eating** — aligned with the National Healthy School Canteen Guidelines
- **Reduce waste** — through nude food and sustainability initiatives
- **Manage behaviour** — high-sugar foods can affect concentration and classroom behaviour
- **Ensure food safety** — preventing foodborne illness in the school environment

Understanding your school's policy is not just about compliance — it helps you pack a lunchbox that works within the school's framework while still being nutritious and appealing to your child.
...
| --- | --- | --- |
| Green — Fill the Menu | Nutritious foods for everyday | Fruit, vegetables, wholegrain sandwiches, water |
| Amber — Select Carefully | Some nutritional value but also some less healthy attributes | Fruit juice, flavoured yoghurt, white bread |
| Red — Occasional | Low nutritional value, high in fat/sugar/salt | Chips, lollies, chocolate, soft drinks |
...
- **Check your school's specific policy** — it is usually on the school website or in the parent handbook
- **Ask at orientation** — many schools cover lunchbox expectations during kindy or new family orientation
- **Reframe the conversation with your child** — instead of "you're not allowed," try "at school we eat foods that help our brains work well"
- **Allow occasional treats** — if the school permits, a small treat on Friday can be something to look forward to
...
"Nude food" means food without packaging — no wrappers, no cling film, no foil, no single-use plastics. Many Australian schools run regular nude food days or have adopted waste-free lunchbox policies entirely.
...
- **Bento-style lunchboxes** (e.g. Yumbox, PlanetBox, Sistema) — multiple compartments mean no need for individual packaging
- **Reusable silicone bags** (e.g. Stasher bags) — for sandwiches, snacks, and cut fruit
- **Beeswax wraps** — a reusable alternative to cling film
- **Reusable water bottles** — stainless steel or BPA-free plastic
...
- Get your child involved — let them choose their reusable containers
...
- **Your child's food is welcome** — rice, dumplings, chapati, sushi, and other cultural foods are perfectly appropriate for school
...
- **Qkr!** (by Mastercard) — used by many NSW and VIC schools
- **Flexischools** — popular across multiple states
- **Munch Monitor** — growing in popularity
...
- Use canteen days as a treat (e.g. once a week) rather than a daily habit — home-packed lunches are almost always healthier and cheaper
...
1. **Read the full policy** — it is usually available on the school website or from the front office
2. **Talk to your child's teacher** — they can clarify expectations
3. **Raise concerns with the principal** — calmly explain your perspective
4. **Join the school P&C** — this is where policies are often discussed and shaped
5. **Propose alternatives** — rather than just objecting, suggest practical solutions
...
Want help packing a lunchbox that meets your school's policy? [Try the Aussie Lunchbox Planner →](/en/planner)
`,
  },

  "lunchbox-food-safety-guide-australia": {
...
A school lunchbox packed at 7am may not be eaten until 12:30pm or later — that is over five hours. In Australian conditions, especially during Terms 1 and 4 when temperatures regularly exceed 30°C, food can enter the "danger zone" (5°C to 60°C) within an hour of leaving the fridge.
...
Bacteria that cause food poisoning multiply rapidly between **5°C and 60°C**. This range is called the "temperature danger zone." At room temperature (around 20-25°C), bacteria can double every 20 minutes. In a hot schoolbag left in the sun, the rate is even faster.
...
| Between 2 and 4 hours total | Safe to eat now, but do not refrigerate — eat or discard |
| More than 4 hours total | Throw away — do not eat |

For a school lunchbox, this means perishable foods should ideally stay below 5°C until lunchtime. If that is not possible, choosing lower-risk foods is the safer option.
...
- **Cooked meats** — sliced chicken, ham, roast beef
- **Dairy** — yoghurt, cheese (soft cheeses are higher risk than hard cheeses)
- **Eggs** — boiled eggs, egg sandwiches, frittata
- **Cooked rice and pasta** — *Bacillus cereus* can grow in cooked rice left at room temperature
- **Dips** — hummus, cream cheese-based dips, guacamole
- **Seafood** — tuna sandwiches, prawn rice paper rolls
- **Cut fruit** — watermelon, rockmelon (whole fruit with skin intact is lower risk)

### Low-Risk Foods (Safer Without Cooling)
These foods are less likely to cause problems if not kept cold:

- **Whole fruit** — apples, bananas, mandarins, pears (uncut, with skin)
- **Dried fruit** — sultanas, apricots, cranberries
- **Crackers and rice cakes**
- **Bread and rolls** (without perishable fillings)
- **Hard cheese** — cheddar, Colby (lower moisture = lower risk)
- **Vegemite sandwiches** — the salt content of Vegemite acts as a preservative
...
- By lunchtime, it will be partially thawed — your child gets cold water to drink
- This doubles as hydration and temperature control

**Frozen Food Items:**
- Freeze yoghurt tubes or pouches overnight — they thaw to a perfect consistency by lunch
- Freeze small water bottles to use as ice packs
- Freeze grapes or blueberries — they act as mini ice packs and defrost by lunchtime
...
- **Insulated bags + ice pack** can keep food below 8°C for 4-5 hours (tested in Australian conditions)
- **Non-insulated bags** offer almost no protection — food reaches room temperature within 1-2 hours
...
- Keep **wet foods away from dry foods** — use separate compartments or small containers
- Pack **hot and cold items in separate containers** — a thermos of soup should not be next to a yoghurt pouch
...
1. **Pre-heat the thermos** — fill with boiling water, let sit for 5 minutes, then empty
2. **Heat food to at least 75°C** (steaming hot) before pouring into the thermos
3. **Fill the thermos as full as possible** — less air space means better heat retention
4. **Do not reuse hot food** — if your child does not eat it at school, throw it away. Do not refrigerate and reheat again.
...
- **Wash the lunchbox every day** — warm soapy water and a brush
- **Dry thoroughly** before packing — moisture promotes bacterial growth
- **Check for cracks or damage** in plastic containers — bacteria can hide in scratches and crevices
...
- Wash hands before eating — encourage your child to use the school's handwashing facilities
...
- Include extra water — children often do not drink enough on excursion days
...
- Hot items heated to 75°C+ and thermos pre-heated? Yes/No (if applicable)
...
- [FSANZ — Food Safety for Consumers](https://www.foodstandards.gov.au/consumer)
- [Health Direct — Food Safety](https://www.healthdirect.gov.au/food-safety)
- [NSW Food Authority — Lunch Boxes](https://www.foodauthority.nsw.gov.au)

---

Keep your kids' lunches safe and delicious. [Try the Aussie Lunchbox Planner →](/en/planner)
`,
  },

  "healthy-snacks-guide-australia": {
...
Most Australian schools schedule at least one snack break (often called "crunch and sip" or "brain break") in addition to the main lunch period. For many children, especially younger ones, snack time is when they actually eat the most — their appetites are better mid-morning than at noon.

A well-chosen snack provides sustained energy for learning, bridges the gap between meals, and contributes meaningfully to your child's daily nutrient intake. A poorly chosen snack — high in sugar, low in fibre and protein — leads to an energy crash and difficulty concentrating.
...
- **Complex carbohydrates** (for sustained energy) — whole grains, fruit, vegetables
- **Protein** (for satiety) — cheese, yoghurt, eggs, legumes, seeds
- **Healthy fats** (for brain function) — avocado, seeds, olive oil, nut butters (where allowed)
...
1. **Whole fruit** — apple, banana, mandarin, pear. No prep needed.
2. **Fruit kebabs** — thread strawberries, grapes (halved for young kids), melon cubes onto a bamboo skewer
3. **Frozen grapes** — freeze overnight; they taste like mini sorbets
4. **Watermelon cubes** — pack in a leak-proof container; add a squeeze of lime for a twist
5. **Apple "sandwiches"** — slice apple into rounds, spread sunflower seed butter between two slices
6. **Berry mix** — combine seasonal berries (strawberries, blueberries, raspberries) in a small container
7. **Banana "sushi"** — spread a tortilla with yoghurt and honey, place a banana at one end, roll tightly, and slice into rounds
8. **Dried fruit mix** — sultanas, dried apricots, dried cranberries. Keep portions small (40-50g) as dried fruit is calorie-dense.
9. **Fruit salad** — dice seasonal fruit and toss with a squeeze of orange juice to prevent browning
10. **Frozen banana pops** — halve a banana, insert a popsicle stick, dip in yoghurt, roll in coconut, freeze
...
11. **Carrot sticks** with hummus — the classic combo
...
14. **Cherry tomatoes** — the "nature's lolly" of the vegetable world
15. **Celery boats** — fill celery sticks with cream cheese or sunflower seed butter and top with sultanas ("ants on a log")
16. **Corn on the cob** — cook, cut into thirds, serve room temperature
17. **Edamame** — lightly salted, in the pod. Many Australian kids love popping them out.
18. **Zucchini chips** — thinly slice, toss with olive oil and salt, bake at 200°C until crispy
19. **Sweet potato wedges** — bake on the weekend, pack cold or at room temperature
20. **Frozen peas** — yes, straight from the freezer. Many kids eat them like lollies. They defrost by snack time.

---

## Dairy & Protein Snacks (10 Ideas)

21. **Cheese cubes** — tasty cheddar, Colby, or mozzarella cut into bite-sized pieces
22. **Yoghurt pouch** — choose options with less than 10g sugar per 100g (or buy plain and flavour with honey at home)
23. **Cheese and crackers** — wholegrain crackers with sliced cheese
24. **Boiled eggs** — cook a batch on Sunday; they keep in the fridge for up to a week. Peel before packing.
25. **Mini frittata muffins** — bake eggs with diced vegetables and cheese in mini muffin tins. Freeze and defrost as needed.
26. **Babybel cheese** — individually wax-wrapped, fun to peel, and portion-controlled
27. **Cottage cheese** with pineapple chunks or cherry tomatoes
28. **String cheese** — a fun, peelable snack that kids enjoy
29. **Tzatziki** — Greek yoghurt, grated cucumber, garlic, and lemon; serve with pita triangles
30. **Tuna and crackers** — a small tin of flavoured tuna with a handful of rice crackers
...
31. **Banana oat cookies** — 2 mashed bananas + 1 cup oats + optional choc chips. Bake at 180°C for 12 minutes. That is it — no flour, no sugar, no eggs.

32. **Savoury muffins** — grate zucchini and cheese into a basic muffin batter. Makes 12; freeze individually.

33. **Bliss balls** — 1 cup oats, 1/2 cup sunflower seed butter, 1/3 cup honey, 1/4 cup coconut. Mix, roll, refrigerate.

34. **Zucchini slice** — the quintessential Australian recipe. Eggs, self-raising flour, grated zucchini, onion, cheese, and bacon (optional).

35. **Pikelets** — simple, kid-friendly, and versatile. Serve plain, with a smear of jam, or with cream cheese.

36. **Cheese scrolls** — roll grated cheese into puff pastry, slice into rounds, bake until golden.

37. **Homemade muesli bars** — oats, honey, butter, and your choice of seeds and dried fruit. Press into a tray, bake, and slice.

38. **Corn fritters** — tinned corn, flour, egg, and spring onion. Pan-fry small patties. Great served cold.

39. **Pizza scrolls** — spread pizza sauce on puff pastry, top with cheese and ham, roll, slice, and bake.

40. **Apple cinnamon oat bars** — oats, grated apple, cinnamon, honey, and a little butter. Press into a tray and bake.
...
- **Roasted chickpeas** — a crunchy, protein-rich alternative to nuts
- **Pumpkin seeds (pepitas)** — roast with a little salt and paprika
- **Sesame snaps** (check school policy on sesame first)
- **Rice crackers** — naturally nut-free; pair with dips
- **Popcorn** — air-popped with a light sprinkle of salt
...
- Like chicken nuggets? Make homemade ones with added vegetable — grated zucchini mixed into the chicken mince
...
Many Australian primary schools participate in the **Crunch&Sip** program (or similar initiatives). This is a designated time — usually mid-morning — for children to eat a fruit or vegetable snack and drink water.
...
- **Sunday batch cook** — spend 1 hour making muffins, bliss balls, or frittata for the week
- **Prep vegetables** on Sunday — wash, peel, and cut carrot sticks, celery, and capsicum. Store in water in the fridge for the week.
- **Freeze in portions** — homemade muffins, scrolls, and slices freeze brilliantly. Pull one out each morning.
- **Keep a "snack drawer"** in the pantry with shelf-stable options: crackers, dried fruit, rice cakes
- **Rotate a two-week menu** — you only need 10 snack ideas, not 50. Repeat every fortnight.

---

Get snack ideas tailored to your family. [Try the Aussie Lunchbox Planner →](/en/planner)
`,
  },

  "vegetarian-vegan-school-lunch-guide-australia": {
...
The main concern parents have is ensuring their child gets enough **protein, iron, calcium, zinc, and vitamin B12** — nutrients that are easily obtained from animal products but require more planning on a plant-based diet. This guide addresses each of these concerns with practical, Australian-specific advice.
...
| Hummus (2 tbsp) | 2g |
| Greek yoghurt (150g) — vegetarian | 10g |

*Check school nut policy before packing nut butters.

The key principle is **protein combining** — eating a variety of plant proteins throughout the day ensures all essential amino acids are covered. You do not need to combine them in a single meal; across the day is sufficient.
...
- **Tofu and tempeh**
- **Fortified cereals** — Weet-Bix, some mueslis
- **Dark leafy greens** — spinach, kale (in wraps, smoothies, or baked into muffins)
...
- B12 supplement (sublingual drops or chewable tablets — consult your GP or paediatrician for dosage)
- Fortified nutritional yeast (savoury, cheesy flavour — great sprinkled on pasta or popcorn)
- Fortified plant milks (check labels — not all are fortified with B12)
...
### Sandwiches & Wraps
1. **Hummus, grated carrot, and cucumber wrap** — protein from chickpeas, crunch from veggies
2. **Egg and lettuce sandwich** — classic, simple, protein-rich
3. **Cheese and Vegemite scroll** — roll Vegemite and grated cheese in puff pastry, bake
4. **Falafel wrap** — homemade or store-bought (Woolworths stocks good options), with salad and tahini
5. **Cream cheese and roasted capsicum sandwich** — sweet, creamy, and satisfying

### Main-Style Items
6. **Fried rice** — use leftover rice, frozen peas, corn, egg (or tofu for vegan), and soy sauce. Pack in a thermos.
7. **Pasta with pesto and cherry tomatoes** — basil pesto (or dairy-free pesto for vegan) with wholegrain pasta
8. **Lentil soup** in a thermos — red lentils cook quickly and are naturally creamy
9. **Sushi rolls** — rice, avocado, cucumber, and carrot. Add tofu or tempeh for protein.
10. **Bean and cheese quesadilla** — fill a tortilla with tinned beans and cheese, pan-fry, slice into wedges

### Protein-Packed Snacks
11. **Edamame** — steamed, lightly salted, in the pod
12. **Roasted chickpeas** — toss tinned chickpeas with olive oil, paprika, and salt. Bake at 200°C for 25 minutes.
13. **Tofu bites** — marinate firm tofu in soy sauce and sesame oil, pan-fry until golden
14. **Boiled eggs** (vegetarian) — cook 6 on Sunday, use across the week
15. **Bean dip with veggie sticks** — blend tinned white beans with garlic, lemon, and olive oil

### Sweet & Fruity
16. **Banana and oat muffins** — naturally sweetened, no egg needed (use flax egg for vegan)
17. **Yoghurt and berry parfait** — layer soy yoghurt (vegan) or Greek yoghurt (vegetarian) with seasonal berries
18. **Energy balls** — oats, dates, sunflower seed butter, and cacao powder
19. **Fruit and seed trail mix** — dried cranberries, sunflower seeds, pumpkin seeds, and coconut flakes
20. **Chia pudding** — mix chia seeds with plant milk and a drizzle of maple syrup; refrigerate overnight. Top with fruit before packing.
...
### Woolworths
- **Woolworths Macro Organic Tofu** — firm, versatile, affordable
- **Bonsoy Soy Milk** — calcium-fortified, great flavour
- **Woolworths Free From** range — dairy-free cheese, yoghurt alternatives
- **Sanitarium So Good** — plant-based yoghurt and milk alternatives
- **Falafel** — in the deli section, ready to eat

### Coles
- **Coles Nature's Kitchen** — plant-based sausages, burgers, nuggets (good for lunchbox variety)
...
- Frame their diet positively — not as restriction but as a choice
...
- Many bakeries now offer vegan cakes and cupcakes — check local options
...
- 1 batch of savoury muffins (12 — freeze 6)
...
- **Annual blood tests** — check iron, B12, vitamin D, and zinc levels with your GP
- **Supplementation** — B12 is essential for vegans; iron and vitamin D may also be needed
- **Consult an Accredited Practising Dietitian** — especially for vegan children under 5. Find one at [Dietitians Australia](https://dietitiansaustralia.org.au/find-an-apd/)
- **Follow the NHMRC guidelines** — the Australian Dietary Guidelines include advice for vegetarian eating patterns
...
- [NHMRC Australian Dietary Guidelines](https://www.eatforhealth.gov.au/guidelines)
- [Dietitians Australia — Vegetarian Diets](https://dietitiansaustralia.org.au)
- [Nutrition Australia — Vegetarian Eating](https://www.nutritionaustralia.org)

---

Ready to plan plant-based lunchboxes? [Try the Aussie Lunchbox Planner →](/en/planner)
`,
  },
};
...
export const GUIDE_CARDS = Object.entries(GUIDES).map(([slug, guide]) => ({
  slug,
  title: guide.title,
